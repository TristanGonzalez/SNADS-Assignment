...
degree_vector <- snafun::v_degree(net)

# Create a binary vector where 1 = high degree, 0 = otherwise
high_degree <- ifelse(degree_vector > 50, 1, 0)
snafun::add_vertex_attributes(net, 'high_degree', high_degree)
snafun::list_vertex_attributes(net)

network::set.vertex.attribute(net, 'high_degree', high_degree)
network::list.vertex.attributes(net)

summary(network::get.vertex.attribute(net, 'high_degree'))
```
